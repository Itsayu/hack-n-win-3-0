...
export default function Countdown() {
  ...
  const TimeBox = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center">
      <div className="w-20 h-20 md:w-28 md:h-28 bg-black dark:bg-white text-white dark:text-black rounded-lg md:rounded-xl flex items-center justify-center border-4 border-red-600 shadow-lg">
